...
_hyb.util.TextFactory = function(parent, text, size)
...
_hyb.util.CheckBoxFactory = function(g_name, parent, checkbtn_text, tooltip_text, on_click_func)
...
_hyb.util.EditBoxFactory = function(g_name, parent, title, w, h, enter_func)
...
_hyb.util.SliderFactory = function(g_name, parent, title, min_val, max_val, val_step, func)
